...
public class LoginActivity extends AppCompatActivity {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()) {
                    ...
                    try {
                        ...
                        excecao = "E-mail e senha não correspondem ao usuário!";
                    } catch(Exception e) {
    ...
    /**
     * Método que vai direcionar o usuário
     * para a tela principal se ele já
     * estiver logado.
     */
    @Override
    ...
    /**
     * Método utilizado para abrir a tela de cadastro
     * quando o usuário clicar no texto 'Não tem
     * conta? Cadastre-se'
     */
    ...
    /**
     * Método para direcionar o usuário para
